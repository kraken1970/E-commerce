...
var buttonMinus = document.querySelectorAll('.number-minus');
var buttonPlus = document.querySelectorAll('.number-plus');
var count = document.querySelectorAll('.number-count');
